...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Produto p9 = new Produto(null, "Abarjour", 100.00);
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p3, p5, p6, p7, p8, p9, p10, p11,p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26,
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "davi.gardin@gmai.com", "36378912377", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("2736332", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "davi.gardin@gmail.com", "42940513023", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("975157224", "32229599"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "3877012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "106", "Sala 800", "Centro", "04040010", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("01/10/2017 19:35"), cli1, e2);
